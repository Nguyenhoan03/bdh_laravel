...
@section('title', 'Chính sách bảo hành - Daniel Wellington Vietnam')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
                            ...
                            <div class="space-y-2 text-slate-600">
                                <p><strong>Địa chỉ:</strong> 123 Phố Huế, Hai Bà Trưng, Hà Nội</p>
                        ...
                        <div class="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
                            ...
                            <div class="space-y-2 text-slate-600">
                                <p><strong>Địa chỉ:</strong> 456 Nguyễn Huệ, Q1, TP.HCM</p>
