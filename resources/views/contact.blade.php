            ...
            <div class="space-y-8">
                ...
                <div class="bg-gradient-to-br from-slate-50 to-blue-50 rounded-3xl p-8 shadow-lg border border-slate-100">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <a href="#" class="flex items-center space-x-3 p-4 bg-white rounded-xl hover:shadow-md transition-all duration-300 group">
                        ...
                        <a href="#" class="flex items-center space-x-3 p-4 bg-white rounded-xl hover:shadow-md transition-all duration-300 group">
                            <div class="w-10 h-10 bg-pink-600 rounded-lg flex items-center justify-center group-hover:bg-pink-700 transition-colors duration-300">
                                <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="#" class="flex items-center space-x-3 p-4 bg-white rounded-xl hover:shadow-md transition-all duration-300 group">
                            <div class="w-10 h-10 bg-blue-800 rounded-lg flex items-center justify-center group-hover:bg-blue-900 transition-colors duration-300">
                                <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
